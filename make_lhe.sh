...
# Switch to your working directory below
echo -e 'cd ../BRIDGE\n' >> scripts/run_${TAG}.csh
echo -e './runBRIsusy.exe ../models/${MODELNAME}/particles.dat ../models/${MODELNAME}/param_card.dat ../models/${MODELNAME}/interactions.dat ../models/${MODELNAME}/ ../models/${MODELNAME}/${MODELNAME} blist t1 t1~ n3 x1+ x1- n2 elist ${SEED} 50000 5 Y\n' >> scripts/run_${TAG}.csh
echo 'if ( ${7} == "HH" ) then' >> scripts/run_${TAG}.csh
...
echo -e 'setenv DELTA `echo "${3}-${5}" | bc`\n' >> scripts/run_${TAG}.csh
echo 'if ( `echo "${DELTA} < 175" | bc` ) then' >> scripts/run_${TAG}.csh
echo './runDGEsusy.exe ../models/${MODELNAME}/particles.dat ../models/${MODELNAME}/param_card.dat ../models/${MODELNAME}/interactions.dat ../${MODELNAME}/Events/${MODELNAME}/unweighted_events.lhe ../${MODELNAME}/Events/${MODELNAME}/${MODELNAME}.lhe ../models/${MODELNAME}/ ${SEED} 3 ../../test/full_decays_offshell.txt' >> scripts/run_${TAG}.csh
echo 'else' >> scripts/run_${TAG}.csh
echo './runDGEsusy.exe ../models/${MODELNAME}/particles.dat ../models/${MODELNAME}/param_card.dat ../models/${MODELNAME}/interactions.dat ../${MODELNAME}/Events/${MODELNAME}/unweighted_events.lhe ../${MODELNAME}/Events/${MODELNAME}/${MODELNAME}.lhe ../models/${MODELNAME}/ ${SEED} 3 ../../test/full_decays_onshell.txt' >> scripts/run_${TAG}.csh
echo -e 'endif\n' >> scripts/run_${TAG}.csh
echo -e 'cd ${MAINDIR}\n' >> scripts/run_${TAG}.csh
